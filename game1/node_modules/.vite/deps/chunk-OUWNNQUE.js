import {
  m as m2
} from "./chunk-PSYBNRKL.js";
import {
  l as l2,
  p as p2,
  t
} from "./chunk-KKM2HNRW.js";
import {
  i as i2
} from "./chunk-6B6RX362.js";
import {
  i
...
function x(o3, a2, n3) {
  ...
  return o3.addComponent(l4, r), o3.addComponent(l4, n), o3.addComponent(l4, o), r.posX[l4] = s3.offset.x, r.posY[l4] = s3.offset.y, r.posZ[l4] = s3.offset.z, r.rotX[l4] = 0, r.rotY[l4] = 0, r.rotZ[l4] = 0, r.rotW[l4] = 1, r.scaleX[l4] = 1, r.scaleY[l4] = 1, r.scaleZ[l4] = 1, n.shape[l4] = 0, n.sizeX[l4] = s3.size.x, n.sizeY[l4] = s3.size.y, n.sizeZ[l4] = s3.size.z, n.color[l4] = s3.color, n.visible[l4] = 1, o.entity[l4] = a2, l4;
}
function Z(o3) {
...
function T(o3, a2, n3, s3, l4) {
  ...
  r.eulerX[o3] = -r3, r.eulerX[a2] = r3, r.eulerX[n3] = c3, r.eulerX[s3] = -c3;
}
function d(o3) {
...
function S(o3, a2, n3, s3, l4, r3, c3) {
  if (c3 < o2.jump.anticipationDuration) {
    ...
    r.eulerX[n3] = -p3 * o2.jump.armRaiseAngle, r.eulerX[s3] = -p3 * o2.jump.armRaiseAngle;
    const X = p3 * o2.jump.bodyStretch;
    r.scaleY[a2] = 1 + X, r.scaleX[a2] = 1 - X * 0.3, r.scaleZ[a2] = 1 - X * 0.3;
    const Y = p3 * o2.jump.legTuckAngle;
    r.eulerX[l4] = Y, r.eulerX[r3] = Y;
  } else {
    const m3 = c3 - o2.jump.anticipationDuration, p3 = Math.sin(m3 * 3) * 5;
    r.eulerX[n3] = -45 + p3, r.eulerX[s3] = -45 - p3;
    const X = Math.sin(m3 * 4) * 0.02;
    r.scaleX[a2] = 1 + X, r.scaleY[a2] = 1, r.scaleZ[a2] = 1 + X, r.eulerX[l4] = o2.jump.legTuckAngle, r.eulerX[r3] = o2.jump.legTuckAngle, r.eulerX[o3] = 10;
  }
}
function k(o3, a2, n3, s3, l4, r3, c3) {
  const m3 = Math.max(0, c3 - 0.3), p3 = Math.sin(m3 * 5) * o2.fall.armFlailAngle;
  r.eulerX[n3] = -12 + p3, r.eulerX[s3] = -12 - p3, r.eulerZ[n3] = -20, r.eulerZ[s3] = 20, r.eulerX[a2] = o2.fall.bodyTiltAngle, r.eulerX[l4] = o2.fall.legDangleAngle, r.eulerX[r3] = o2.fall.legDangleAngle, r.eulerX[o3] = 20;
  const X = Math.sin(m3 * 2.5) * o2.fall.windSwayAmount;
  r.posX[a2] = X, r.posX[o3] = X * 0.5;
}
function D(o3, a2, n3) {
  const s3 = n3 / o2.landing.duration, l4 = Math.exp(-s3 * 8) * o2.landing.bounceHeight, r3 = Math.sin(s3 * Math.PI * 2) * l4;
  r.posY[a2] = e.torso.offset.y + r3, r.posY[o3] = e.head.offset.y + r3;
  const c3 = Math.exp(-s3 * 6) * o2.landing.squashAmount;
  r.scaleX[a2] = 1 + c3 * 0.4, r.scaleY[a2] = 1 - c3 * 0.8, r.scaleZ[a2] = 1 + c3 * 0.4;
}
function C(o3, a2, n3, s3, l4, r3) {
  r.posX[o3] = e.head.offset.x, r.posY[o3] = e.head.offset.y, r.posZ[o3] = e.head.offset.z, r.posX[a2] = e.torso.offset.x, r.posY[a2] = e.torso.offset.y, r.posZ[a2] = e.torso.offset.z, r.eulerX[o3] = 0, r.eulerY[o3] = 0, r.eulerZ[o3] = 0, r.eulerX[a2] = 0, r.eulerY[a2] = 0, r.eulerZ[a2] = 0, r.eulerX[n3] = 0, r.eulerY[n3] = 0, r.eulerZ[n3] = 0, r.eulerX[s3] = 0, r.eulerY[s3] = 0, r.eulerZ[s3] = 0, r.eulerX[l4] = 0, r.eulerY[l4] = 0, r.eulerZ[l4] = 0, r.eulerX[r3] = 0, r.eulerY[r3] = 0, r.eulerZ[r3] = 0, r.scaleX[o3] = 1, r.scaleY[o3] = 1, r.scaleZ[o3] = 1, r.scaleX[a2] = 1, r.scaleY[a2] = 1, r.scaleZ[a2] = 1;
}
...
var S2 = defineQuery([c2]);
var L = defineQuery([t]);
var D2 = defineQuery([r2]);
var R = defineQuery([t]);
var N2 = {
  group: "setup",
  update: (r3) => {
    ...
    if (m3.length === 0 && o3.length === 0) {
      ...
      r3.addComponent(p3, c2), r3.addComponent(p3, s);
    }
  }
};
var $ = {
  ...
  update: (r3) => {
    if (L(r3.world).length === 0) {
      ...
      r3.addComponent(o3, t), r3.addComponent(o3, p), r3.addComponent(o3, r), r3.addComponent(o3, c), c.type[o3] = p2.type, c.mass[o3] = p2.mass, c.posX[o3] = p2.posX, c.posY[o3] = p2.posY, c.posZ[o3] = p2.posZ, c.eulerX[o3] = p2.eulerX, c.eulerY[o3] = p2.eulerY, c.eulerZ[o3] = p2.eulerZ, c.rotX[o3] = 0, c.rotY[o3] = 0, c.rotZ[o3] = 0, c.rotW[o3] = 1, c.velX[o3] = p2.velX, c.velY[o3] = p2.velY, c.velZ[o3] = p2.velZ, c.rotVelX[o3] = p2.rotVelX, c.rotVelY[o3] = p2.rotVelY, c.rotVelZ[o3] = p2.rotVelZ, c.linearDamping[o3] = p2.linearDamping, c.angularDamping[o3] = p2.angularDamping, c.gravityScale[o3] = p2.gravityScale, c.ccd[o3] = p2.ccd, c.lockRotX[o3] = p2.lockRotX, c.lockRotY[o3] = p2.lockRotY, c.lockRotZ[o3] = p2.lockRotZ, r3.addComponent(o3, l), l.shape[o3] = l2.shape, l.radius[o3] = l2.radius, l.height[o3] = l2.height, l.sizeX[o3] = l2.sizeX, l.sizeY[o3] = l2.sizeY, l.sizeZ[o3] = l2.sizeZ, l.friction[o3] = l2.friction, l.restitution[o3] = l2.restitution, l.density[o3] = l2.density, l.isSensor[o3] = l2.isSensor, l.membershipGroups[o3] = l2.membershipGroups, l.filterGroups[o3] = l2.filterGroups, l.posOffsetX[o3] = l2.posOffsetX, l.posOffsetY[o3] = l2.posOffsetY, l.posOffsetZ[o3] = l2.posOffsetZ, l.rotOffsetX[o3] = l2.rotOffsetX, l.rotOffsetY[o3] = l2.rotOffsetY, l.rotOffsetZ[o3] = l2.rotOffsetZ, l.rotOffsetW[o3] = l2.rotOffsetW, r3.addComponent(o3, u), r3.addComponent(o3, i), r3.addComponent(o3, m2);
    }
  }
};
var oo = {
  ...
  update: (r3) => {
    if (D2(r3.world).length === 0) {
      const o3 = r3.createEntity();
      r3.addComponent(o3, i2), r3.addComponent(o3, r), r3.addComponent(o3, r2), r3.addComponent(o3, i), i2.inputSource[o3] = o3;
    }
  }
};
var ro = {
  ...
  update(r3) {
    ...
    for (const o3 of m3) {
      const p3 = r3.createEntity();
      r3.addComponent(o3, a), r3.addComponent(p3, r), r3.addComponent(p3, o), r3.addComponent(p3, n2), r.posY[p3] = 0.75, o.entity[p3] = o3;
    }
  }
};
...
//# sourceMappingURL=chunk-OUWNNQUE.js.map
