...
var X = defineQuery([n]);
var Y2 = defineQuery([s2]);
var Z2 = defineQuery([c]);
var I2 = defineQuery([r, s]);
var _ = defineQuery([r]);
var E = defineQuery([t]);
var B = {
  group: "draw",
...
var J = {
  ...
  update(e) {
    ...
    for (const i of r2) {
      ...
      t2 || (t2 = new HemisphereLight(), n2.add(t2), o.lights.ambient = t2), t2.color.setHex(s2.skyColor[i]), t2.groundColor.setHex(s2.groundColor[i]), t2.intensity = s2.intensity[i];
    }
    const s3 = Z2(e.world);
    for (const i of s3) {
...
//# sourceMappingURL=chunk-57EKG5BB.js.map
