import { Effect as o } from "../../../node_modules/postprocessing/build/index.js";
import { Uniform as t } from "three";
const i = (
  /* glsl */
  `
...
class l extends o {
  constructor(e) {
    super("DitheringEffect", i, {
      uniforms: /* @__PURE__ */ new Map([
        ["colorBits", new t(e?.colorBits ?? 4)],
        ["intensity", new t(e?.intensity ?? 1)],
        ["grayscale", new t(e?.grayscale ? 1 : 0)],
        ["scale", new t(e?.scale ?? 1)],
        ["noise", new t(e?.noise ?? 1.2)]
      ])
    });
  }
  get colorBits() {
  ...
  set colorBits(e) {
    this.uniforms.get("colorBits").value = e;
  }
  get intensity() {
  ...
  set grayscale(e) {
    this.uniforms.get("grayscale").value = e ? 1 : 0;
  }
  get scale() {
  ...
  set noise(e) {
    this.uniforms.get("noise").value = e;
  }
}
export {
  l as DitheringEffect
};
//# sourceMappingURL=dithering-effect.js.map
