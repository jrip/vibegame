import { z } from 'zod';
import { vector3Schema, vector2Schema, colorSchema, shapeSchema, bodyTypeSchema, transformComponentSchema, bodyComponentSchema, colliderComponentSchema, rendererComponentSchema, orbitCameraComponentSchema, playerComponentSchema, entityRecipeSchema, staticPartRecipeSchema, dynamicPartRecipeSchema, kinematicPartRecipeSchema, playerRecipeSchema, cameraRecipeSchema, worldRecipeSchema, RecipeSchemas, RecipeName, RecipeAttributes } from './schemas';
