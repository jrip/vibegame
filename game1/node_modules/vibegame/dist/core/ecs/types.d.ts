...
import { ParsedElement, XMLValue } from '../xml';
import { ParseContext } from '../recipes/parse-context';
...
export interface ValidationRule {
    readonly condition: (recipeName: string, attributes: Record<string, XMLValue>) => boolean;
