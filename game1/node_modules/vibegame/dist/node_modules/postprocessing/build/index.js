import { Vector2 as h, UnsignedByteType as P, SRGBColorSpace as v, DepthTexture as ge, DepthStencilFormat as he, UnsignedInt248Type as ve, UnsignedIntType as pe, WebGLRenderTarget as x, LinearFilter as O, Uniform as l, Color as ae, LoadingManager as me, Texture as z, NearestFilter as Q, BasicDepthPacking as L, LinearMipmapLinearFilter as Be, REVISION as H, Scene as q, Camera as De, Mesh as Ee, BackSide as U, DoubleSide as F, ShaderMaterial as M, FrontSide as Ce, EventDispatcher as W, LinearSRGBColorSpace as oe, NoColorSpace as ce, NoBlending as I, Material as le, BufferGeometry as xe, BufferAttribute as _, PerspectiveCamera as we, Vector4 as $ } from "three";
/**
...
var Y = 1 / 1e3, Te = 1e3, Me = class {
  ...
  get fixedDelta() {
    return this._fixedDelta * Y;
  }
  set fixedDelta(e) {
    this._fixedDelta = e * Te;
  }
  get elapsed() {
    return this._elapsed * Y;
  }
  /**
   * Updates this timer.
   *
  ...
  const e = new Float32Array([-1, -1, 0, 3, -1, 0, -1, 3, 0]), t = new Float32Array([0, 0, 2, 0, 0, 2]), i = new xe();
  return i.setAttribute("position", new _(e, 3)), i.setAttribute("uv", new _(t, 2)), i;
})(), C = class X {
  /**
   ...
   */
  constructor(t = "Pass", i = new q(), s = new De()) {
  ...
  set fullscreenMaterial(t) {
    let i = this.screen;
    i !== null ? i.material = t : (i = new Ee(X.fullscreenGeometry, t), i.frustumCulled = !1, this.scene === null && (this.scene = new q()), this.scene.add(i), this.screen = i);
  }
  /**
  ...
  dispose() {
    for (const t of Object.keys(this)) {
      const i = this[t];
      (i instanceof x || i instanceof le || i instanceof z || i instanceof X) && this[t].dispose();
    }
...
#include <dithering_fragment>
}`, K = "varying vec2 vUv;void main(){vUv=position.xy*0.5+0.5;gl_Position=vec4(position.xy,1.0,1.0);}", ue = class extends M {
  /**
   ...
   */
  constructor(e, t = !0) {
    super("CopyPass"), this.fullscreenMaterial = new ue(), this.needsSwap = !1, this.renderTarget = e, e === void 0 && (this.renderTarget = new x(1, 1, {
      minFilter: O,
      magFilter: O,
      stencilBuffer: !1,
      depthBuffer: !1
   ...
   */
  initialize(e, t, i) {
    i !== void 0 && (this.renderTarget.texture.type = i, i !== P ? this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1" : e !== null && e.outputColorSpace === v && (this.renderTarget.texture.colorSpace = v));
  }
}, ee = /* @__PURE__ */ new ae(), J = class extends C {
  /**
   ...
   */
  render(e, t, i, s, r) {
    const n = this.overrideClearColor, a = this.overrideClearAlpha, o = e.getClearAlpha(), c = n !== null, A = a >= 0;
    c ? (e.getClearColor(ee), e.setClearColor(n, A ? a : o)) : A && e.setClearAlpha(a), e.setRenderTarget(this.renderToScreen ? null : t), e.clear(this.color, this.depth, this.stencil), c ? e.setClearColor(ee, o) : A && e.setClearAlpha(o);
  }
}, ye = class extends C {
  /**
   ...
   */
  constructor(e, t) {
    super("MaskPass", e, t), this.needsSwap = !1, this.clearPass = new J(!1, !1, !0), this.inverse = !1;
  }
  set mainScene(e) {
    this.scene = e;
  }
   ...
   */
  render(e, t, i, s, r) {
    const n = e.getContext(), a = e.state.buffers, o = this.scene, c = this.camera, A = this.clearPass, p = this.inverted ? 0 : 1, d = 1 - p;
    a.color.setMask(!1), a.depth.setMask(!1), a.color.setLocked(!0), a.depth.setLocked(!0), a.stencil.setTest(!0), a.stencil.setOp(n.REPLACE, n.REPLACE, n.REPLACE), a.stencil.setFunc(n.ALWAYS, p, 4294967295), a.stencil.setClear(d), a.stencil.setLocked(!0), this.clearPass.enabled && (this.renderToScreen ? A.render(e, null) : (A.render(e, t), A.render(e, i))), this.renderToScreen ? (e.setRenderTarget(null), e.render(o, c)) : (e.setRenderTarget(t), e.render(o, c), e.setRenderTarget(i), e.render(o, c)), a.color.setLocked(!1), a.depth.setLocked(!1), a.stencil.setLocked(!1), a.stencil.setFunc(n.EQUAL, 1, 4294967295), a.stencil.setOp(n.KEEP, n.KEEP, n.KEEP), a.stencil.setLocked(!0);
  }
}, Xt = class {
  /**
  ...
  constructor(e = null, {
    ...
    this.renderer = null, this.inputBuffer = this.createBuffer(t, i, r, s), this.outputBuffer = this.inputBuffer.clone(), this.copyPass = new Ae(), this.depthTexture = null, this.passes = [], this.timer = new Me(), this.autoRenderToScreen = !0, this.setRenderer(e);
  }
  /**
  ...
  setRenderer(e) {
    if (this.renderer = e, e !== null) {
      const t = e.getSize(new h()), i = e.getContext().getContextAttributes().alpha, s = this.inputBuffer.texture.type;
      s === P && e.outputColorSpace === v && (this.inputBuffer.texture.colorSpace = v, this.outputBuffer.texture.colorSpace = v, this.inputBuffer.dispose(), this.outputBuffer.dispose()), e.autoClear = !1, this.setSize(t.width, t.height);
  ...
  createDepthTexture() {
    ...
    return this.inputBuffer.depthTexture = e, this.inputBuffer.dispose(), this.inputBuffer.stencilBuffer ? (e.format = he, e.type = ve) : e.type = pe, e;
  }
  /**
  ...
  createBuffer(e, t, i, s) {
    const r = this.renderer, n = r === null ? new h() : r.getDrawingBufferSize(new h()), a = {
      minFilter: O,
      magFilter: O,
      stencilBuffer: t,
      depthBuffer: e,
      type: i
    }, o = new x(n.width, n.height, a);
    return s > 0 && (o.ignoreDepthForMultisampleCopy = !1, o.samples = s), i === P && r !== null && r.outputColorSpace === v && (o.texture.colorSpace = v), o.texture.name = "EffectComposer.Buffer", o.texture.generateMipmaps = !1, o;
  }
  /**
   ...
   */
  addPass(e, t) {
    const i = this.passes, s = this.renderer, r = s.getDrawingBufferSize(new h()), n = s.getContext().getContextAttributes().alpha, a = this.inputBuffer.texture.type;
  ...
  render(e) {
    ...
    let s = this.inputBuffer, r = this.outputBuffer, n = !1, a, o, c;
    e === void 0 && (this.timer.update(), e = this.timer.getDelta());
    for (const A of this.passes)
      A.enabled && (A.render(t, s, r, e, n), A.needsSwap && (n && (i.renderToScreen = A.renderToScreen, a = t.getContext(), o = t.state.buffers.stencil, o.setFunc(a.NOTEQUAL, 1, 4294967295), i.render(t, s, r, e, n), o.setFunc(a.EQUAL, 1, 4294967295)), c = s, s = r, r = c), A instanceof ye ? n = !0 : A instanceof Ie && (n = !1));
  }
  /**
   ...
   */
  setSize(e, t, i) {
    const s = this.renderer, r = s.getSize(new h());
    (e === void 0 || t === void 0) && (e = r.width, t = r.height), (r.width !== e || r.height !== t) && s.setSize(e, t, i);
    const n = s.getDrawingBufferSize(new h());
  ...
  dispose() {
    for (const e of this.passes)
      e.dispose();
    this.passes = [], this.inputBuffer !== null && this.inputBuffer.dispose(), this.outputBuffer !== null && this.outputBuffer.dispose(), this.deleteDepthTexture(), this.copyPass.dispose(), this.timer.dispose(), C.fullscreenGeometry.dispose();
  }
}, S = {
  NONE: 0,
  DEPTH: 1,
  ...
  constructor() {
    ...
    ]), this.defines = /* @__PURE__ */ new Map(), this.uniforms = /* @__PURE__ */ new Map(), this.blendModes = /* @__PURE__ */ new Map(), this.extensions = /* @__PURE__ */ new Set(), this.attributes = S.NONE, this.varyings = /* @__PURE__ */ new Set(), this.uvTransformation = !1, this.readDepth = !1, this.colorSpace = oe;
  }
}, V = !1, te = class {
  /**
  ...
  setMaterial(e) {
    if (this.disposeMaterials(), this.material = e, e !== null) {
      ...
      for (const i of t)
        i.uniforms = Object.assign({}, e.uniforms), i.side = Ce;
      t[2].skinning = !0, this.materialsBackSide = t.map((i) => {
        const s = this.cloneMaterial(i);
        return s.uniforms = Object.assign({}, e.uniforms), s.side = U, s;
      }), this.materialsDoubleSide = t.map((i) => {
        const s = this.cloneMaterial(i);
        return s.uniforms = Object.assign({}, e.uniforms), s.side = F, s;
        ...
        const s = this.cloneMaterial(i);
        return s.uniforms = Object.assign({}, e.uniforms), s.flatShading = !0, s.side = U, s;
      }), this.materialsFlatShadedDoubleSide = t.map((i) => {
        const s = this.cloneMaterial(i);
        return s.uniforms = Object.assign({}, e.uniforms), s.flatShading = !0, s.side = F, s;
      });
    }
  }
  /**
  ...
  updateEffectiveSize() {
    ...
    t.width !== y ? i.width = t.width : t.height !== y ? i.width = Math.round(t.height * (e.width / Math.max(e.height, 1))) : i.width = Math.round(e.width * s), t.height !== y ? i.height = t.height : t.width !== y ? i.height = Math.round(t.width / Math.max(e.width / Math.max(e.height, 1), 1)) : i.height = Math.round(e.height * s);
  }
  /**
   * The effective width.
   *
  ...
  set scale(e) {
    this.s !== e && (this.s = e, this.preferredSize.setScalar(y), this.dispatchEvent({ type: "change" }), this.resizable.setSize(this.baseSize.width, this.baseSize.height));
  }
  /**
  ...
  SUBTRACT: 31,
  VIVID_LIGHT: 32
}, Oe = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(x.rgb+y.rgb,y.a),opacity);}", Le = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,y,y.a*opacity);}", be = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4((x.rgb+y.rgb)*0.5,y.a),opacity);}", He = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 xHSL=RGBToHSL(x.rgb);vec3 yHSL=RGBToHSL(y.rgb);vec3 z=HSLToRGB(vec3(yHSL.xy,xHSL.z));return mix(x,vec4(z,y.a),opacity);}", Ge = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 a=x.rgb,b=y.rgb;vec3 z=mix(step(0.0,b)*(1.0-min(vec3(1.0),(1.0-a)/b)),vec3(1.0),step(1.0,a));return mix(x,vec4(z,y.a),opacity);}", Ue = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 a=x.rgb,b=y.rgb;vec3 z=step(0.0,a)*mix(min(vec3(1.0),a/max(1.0-b,1e-9)),vec3(1.0),step(1.0,b));return mix(x,vec4(z,y.a),opacity);}", Fe = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(min(x.rgb,y.rgb),y.a),opacity);}", ze = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(abs(x.rgb-y.rgb),y.a),opacity);}", Qe = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(x.rgb/max(y.rgb,1e-12),y.a),opacity);}", Ne = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4((x.rgb+y.rgb-2.0*x.rgb*y.rgb),y.a),opacity);}", ke = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 a=min(x.rgb,1.0);vec3 b=min(y.rgb,1.0);vec3 z=mix(2.0*a*b,1.0-2.0*(1.0-a)*(1.0-b),step(0.5,b));return mix(x,vec4(z,y.a),opacity);}", Ye = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(step(1.0,x.rgb+y.rgb),y.a),opacity);}", Ve = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 xHSL=RGBToHSL(x.rgb);vec3 yHSL=RGBToHSL(y.rgb);vec3 z=HSLToRGB(vec3(yHSL.x,xHSL.yz));return mix(x,vec4(z,y.a),opacity);}", Xe = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(1.0-y.rgb,y.a),opacity);}", We = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(y.rgb*(1.0-x.rgb),y.a),opacity);}", Ke = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(max(x.rgb,y.rgb),y.a),opacity);}", Je = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(clamp(y.rgb+x.rgb-1.0,0.0,1.0),y.a),opacity);}", je = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(min(x.rgb+y.rgb,1.0),y.a),opacity);}", Ze = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(clamp(2.0*y.rgb+x.rgb-1.0,0.0,1.0),y.a),opacity);}", qe = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 xHSL=RGBToHSL(x.rgb);vec3 yHSL=RGBToHSL(y.rgb);vec3 z=HSLToRGB(vec3(xHSL.xy,yHSL.z));return mix(x,vec4(z,y.a),opacity);}", _e = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(x.rgb*y.rgb,y.a),opacity);}", $e = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(1.0-abs(1.0-x.rgb-y.rgb),y.a),opacity);}", et = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,y,opacity);}", tt = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 z=mix(2.0*y.rgb*x.rgb,1.0-2.0*(1.0-y.rgb)*(1.0-x.rgb),step(0.5,x.rgb));return mix(x,vec4(z,y.a),opacity);}", it = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 y2=2.0*y.rgb;vec3 z=mix(mix(y2,x.rgb,step(0.5*x.rgb,y.rgb)),max(y2-1.0,vec3(0.0)),step(x.rgb,y2-1.0));return mix(x,vec4(z,y.a),opacity);}", st = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 z=mix(min(x.rgb*x.rgb/max(1.0-y.rgb,1e-12),1.0),y.rgb,step(1.0,y.rgb));return mix(x,vec4(z,y.a),opacity);}", rt = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 xHSL=RGBToHSL(x.rgb);vec3 yHSL=RGBToHSL(y.rgb);vec3 z=HSLToRGB(vec3(xHSL.x,yHSL.y,xHSL.z));return mix(x,vec4(z,y.a),opacity);}", nt = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(x.rgb+y.rgb-min(x.rgb*y.rgb,1.0),y.a),opacity);}", at = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 a=x.rgb;vec3 b=y.rgb;vec3 y2=2.0*b;vec3 w=step(0.5,b);vec3 c=a-(1.0-y2)*a*(1.0-a);vec3 d=mix(a+(y2-1.0)*(sqrt(a)-a),a+(y2-1.0)*a*((16.0*a-12.0)*a+3.0),w*(1.0-step(0.25,a)));vec3 z=mix(c,d,w);return mix(x,vec4(z,y.a),opacity);}", ot = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return y;}", ct = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(max(x.rgb+y.rgb-1.0,0.0),y.a),opacity);}", lt = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 z=mix(max(1.0-min((1.0-x.rgb)/(2.0*y.rgb),1.0),0.0),min(x.rgb/(2.0*(1.0-y.rgb)),1.0),step(0.5,y.rgb));return mix(x,vec4(z,y.a),opacity);}", ut = /* @__PURE__ */ new Map([
  [u.ADD, Oe],
  [u.ALPHA, Le],
  [u.AVERAGE, be],
  [u.COLOR, He],
   ...
   */
  getShaderCode() {
    return ut.get(this.blendFunction);
  }
}, j = class extends W {
  /**
  ...
  constructor(e, t, {
    attributes: i = S.NONE,
    blendFunction: s = u.NORMAL,
    defines: r = /* @__PURE__ */ new Map(),
    uniforms: n = /* @__PURE__ */ new Map(),
    extensions: a = null,
    vertexShader: o = null
  } = {}) {
    super(), this.name = e, this.renderer = null, this.attributes = i, this.fragmentShader = t, this.vertexShader = o, this.defines = r, this.uniforms = n, this.extensions = a, this.blendMode = new At(s), this.blendMode.addEventListener("change", (c) => this.setChanged()), this._inputColorSpace = oe, this._outputColorSpace = ce;
  }
  /**
  ...
  dispose() {
    for (const e of Object.keys(this)) {
      const t = this[e];
      (t instanceof x || t instanceof le || t instanceof z || t instanceof C) && this[e].dispose();
    }
  }
}, Z = {
  MEDIUM: 2,
  LARGE: 3
}, ft = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
#include <colorspace_fragment>
}`, dt = "uniform vec4 texelSize;uniform float kernel;uniform float scale;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;void main(){vec2 uv=position.xy*0.5+0.5;vec2 dUv=(texelSize.xy*vec2(kernel)+texelSize.zw)*scale;vUv0=vec2(uv.x-dUv.x,uv.y+dUv.y);vUv1=vec2(uv.x+dUv.x,uv.y+dUv.y);vUv2=vec2(uv.x+dUv.x,uv.y-dUv.y);vUv3=vec2(uv.x-dUv.x,uv.y-dUv.y);gl_Position=vec4(position.xy,1.0,1.0);}", gt = [
  ...
  constructor(e = new $()) {
    super({
      ...
      fragmentShader: ft,
      vertexShader: dt
    }), this.setTexelSize(e.x, e.y), this.kernelSize = Z.MEDIUM;
  }
  /**
   * The input buffer.
   *
  ...
  constructor({
    ...
    super("KawaseBlurPass"), this.renderTargetA = new x(1, 1, { depthBuffer: !1 }), this.renderTargetA.texture.name = "Blur.Target.A", this.renderTargetB = this.renderTargetA.clone(), this.renderTargetB.texture.name = "Blur.Target.B";
    const a = this.resolution = new T(this, r, n, t);
    a.addEventListener("change", (o) => this.setSize(a.baseWidth, a.baseHeight)), this._blurMaterial = new ht(), this._blurMaterial.kernelSize = e, this.copyMaterial = new ue();
  }
  /**
   ...
   */
  render(e, t, i, s, r) {
    const n = this.scene, a = this.camera, o = this.renderTargetA, c = this.renderTargetB, A = this.blurMaterial, p = A.kernelSequence;
    let d = t;
    this.fullscreenMaterial = A;
    for (let g = 0, B = p.length; g < B; ++g) {
      const R = g & 1 ? c : o;
      A.kernel = p[g], A.inputBuffer = d.texture, e.setRenderTarget(R), e.render(n, a), d = R;
    }
   ...
   */
  initialize(e, t, i) {
    i !== void 0 && (this.renderTargetA.texture.type = i, this.renderTargetB.texture.type = i, i !== P ? (this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1", this.copyMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1") : e !== null && e.outputColorSpace === v && (this.renderTargetA.texture.colorSpace = v, this.renderTargetB.texture.colorSpace = v));
  }
  /**
   * An auto sizing flag.
   *
...
gl_FragColor=vec4(l*mask);
  ...
  constructor({
    ...
    super("LuminancePass"), this.fullscreenMaterial = new mt(i, t), this.needsSwap = !1, this.renderTarget = e, this.renderTarget === void 0 && (this.renderTarget = new x(1, 1, { depthBuffer: !1 }), this.renderTarget.texture.name = "LuminancePass.Target");
    const c = this.resolution = new T(this, a, o, s);
    c.addEventListener("change", (A) => this.setSize(c.baseWidth, c.baseHeight));
  }
  /**
...
}, Bt = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
#include <colorspace_fragment>
}`, xt = "uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;varying vec2 vUv4;varying vec2 vUv5;varying vec2 vUv6;varying vec2 vUv7;void main(){vUv=position.xy*0.5+0.5;vUv0=vUv+texelSize*vec2(-1.0,1.0);vUv1=vUv+texelSize*vec2(0.0,1.0);vUv2=vUv+texelSize*vec2(1.0,1.0);vUv3=vUv+texelSize*vec2(-1.0,0.0);vUv4=vUv+texelSize*vec2(1.0,0.0);vUv5=vUv+texelSize*vec2(-1.0,-1.0);vUv6=vUv+texelSize*vec2(0.0,-1.0);vUv7=vUv+texelSize*vec2(1.0,-1.0);gl_Position=vec4(position.xy,1.0,1.0);}", wt = class extends M {
  /**
   ...
   */
  constructor() {
    super("MipmapBlurPass"), this.needsSwap = !1, this.renderTarget = new x(1, 1, { depthBuffer: !1 }), this.renderTarget.texture.name = "Upsampling.Mipmap0", this.downsamplingMipmaps = [], this.upsamplingMipmaps = [], this.downsamplingMaterial = new Et(), this.upsamplingMaterial = new wt(), this.resolution = new h();
  }
  /**
   ...
   */
  render(e, t, i, s, r) {
    const { scene: n, camera: a } = this, { downsamplingMaterial: o, upsamplingMaterial: c } = this, { downsamplingMipmaps: A, upsamplingMipmaps: p } = this;
    let d = t;
    this.fullscreenMaterial = o;
    for (let g = 0, B = A.length; g < B; ++g) {
      const R = A[g];
      o.setSize(d.width, d.height), o.inputBuffer = d.texture, e.setRenderTarget(R), e.render(n, a), d = R;
    }
    this.fullscreenMaterial = c;
    for (let g = p.length - 1; g >= 0; --g) {
      const B = p[g];
      c.setSize(d.width, d.height), c.inputBuffer = d.texture, c.supportBuffer = A[g].texture, e.setRenderTarget(B), e.render(n, a), d = B;
    }
  }
  /**
   * Updates the size of this pass.
  ...
  initialize(e, t, i) {
    if (i !== void 0) {
      ...
      else if (e !== null && e.outputColorSpace === v)
        for (const r of s)
          r.texture.colorSpace = v;
    }
  }
  /**
...
}, Mt = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D map;
#else
uniform lowp sampler2D map;
#endif
uniform float intensity;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec4 texel=texture2D(map,uv);outputColor=vec4(texel.rgb*intensity,max(inputColor.a,texel.a));}`, Wt = class extends j {
  /**
  ...
  constructor({
    ...
    radius: n = 0.85,
    levels: a = 8,
    kernelSize: o = Z.LARGE,
    resolutionScale: c = 0.5,
    width: A = T.AUTO_SIZE,
    height: p = T.AUTO_SIZE,
    resolutionX: d = A,
    resolutionY: g = p
  } = {}) {
    super("BloomEffect", Mt, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["map", new l(null)],
        ["intensity", new l(r)]
      ])
    }), this.renderTarget = new x(1, 1, { depthBuffer: !1 }), this.renderTarget.texture.name = "Bloom.Target", this.blurPass = new vt({ kernelSize: o }), this.luminancePass = new fe({ colorOutput: !0 }), this.luminanceMaterial.threshold = t, this.luminanceMaterial.smoothing = i, this.mipmapBlurPass = new Tt(), this.mipmapBlurPass.enabled = s, this.mipmapBlurPass.radius = n, this.mipmapBlurPass.levels = a, this.uniforms.get("map").value = s ? this.mipmapBlurPass.texture : this.renderTarget.texture;
    const B = this.resolution = new T(this, d, g, c);
    B.addEventListener("change", (R) => this.setSize(B.baseWidth, B.baseHeight));
  }
  /**
   ...
   */
  initialize(e, t, i) {
    this.blurPass.initialize(e, t, i), this.luminancePass.initialize(e, t, i), this.mipmapBlurPass.initialize(e, t, i), i !== void 0 && (this.renderTarget.texture.type = i, e !== null && e.outputColorSpace === v && (this.renderTarget.texture.colorSpace = v));
  }
}, ie = class extends C {
  /**
  ...
  constructor(e, t, i = null) {
    super("RenderPass", e, t), this.needsSwap = !1, this.clearPass = new J(), this.overrideMaterialManager = i === null ? null : new te(i), this.ignoreBackground = !1, this.skipShadowMapUpdate = !1, this.selection = null;
  }
  set mainScene(e) {
    this.scene = e;
  }
  ...
  set overrideMaterial(e) {
    ...
    e !== null ? t !== null ? t.setMaterial(e) : this.overrideMaterialManager = new te(e) : t !== null && (t.dispose(), this.overrideMaterialManager = null);
  }
  /**
  ...
  AGX: 7,
  NEUTRAL: 8
}, It = `varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;
...
#endif
}`, Rt = `uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;
#if EDGE_DETECTION_MODE != 0
varying vec2 vUv2;varying vec2 vUv3;varying vec2 vUv4;varying vec2 vUv5;
#endif
...
#endif
gl_Position=vec4(position.xy,1.0,1.0);}`, yt = class extends M {
  /**
   ...
   */
  constructor(e = new h(), t = de.COLOR) {
    super({
...
}, Pt = `#define sampleLevelZeroOffset(t, coord, offset) texture2D(t, coord + offset * texelSize)
#if __VERSION__ < 300
...
vec2 d;vec3 coords;coords.x=searchXLeft(vOffset[0].xy,vOffset[2].x);coords.y=vOffset[1].y;d.x=coords.x;float e1=texture2D(inputBuffer,coords.xy).r;coords.z=searchXRight(vOffset[0].zw,vOffset[2].y);d.y=coords.z;d=round(resolution.xx*d+-vPixCoord.xx);vec2 sqrtD=sqrt(abs(d));float e2=sampleLevelZeroOffset(inputBuffer,coords.zy,vec2(1,0)).r;weights.rg=area(sqrtD,e1,e2,subsampleIndices.y);coords.y=vUv.y;detectHorizontalCornerPattern(weights.rg,coords.xyzy,d);
...
#endif
}if(e.r>0.0){vec2 d;vec3 coords;coords.y=searchYUp(vOffset[1].xy,vOffset[2].z);coords.x=vOffset[0].x;d.x=coords.y;float e1=texture2D(inputBuffer,coords.xy).g;coords.z=searchYDown(vOffset[1].zw,vOffset[2].w);d.y=coords.z;d=round(resolution.yy*d-vPixCoord.yy);vec2 sqrtD=sqrt(abs(d));float e2=sampleLevelZeroOffset(inputBuffer,coords.xz,vec2(0,1)).g;weights.ba=area(sqrtD,e1,e2,subsampleIndices.x);coords.x=vUv.x;detectVerticalCornerPattern(weights.ba,coords.xyxz,d);}gl_FragColor=weights;}`, Ot = "uniform vec2 texelSize;uniform vec2 resolution;varying vec2 vUv;varying vec4 vOffset[3];varying vec2 vPixCoord;void main(){vUv=position.xy*0.5+0.5;vPixCoord=vUv*resolution;vOffset[0]=vUv.xyxy+texelSize.xyxy*vec4(-0.25,-0.125,1.25,-0.125);vOffset[1]=vUv.xyxy+texelSize.xyxy*vec4(-0.125,-0.25,-0.125,1.25);vOffset[2]=vec4(vOffset[0].xz,vOffset[1].yw)+vec4(-2.0,2.0,-2.0,2.0)*texelSize.xxyy*MAX_SEARCH_STEPS_FLOAT;gl_Position=vec4(position.xy,1.0,1.0);}", Lt = class extends M {
  /**
   ...
   */
  constructor({
    blendFunction: e = u.SRC,
    preset: t = b.MEDIUM,
    edgeDetectionMode: i = de.COLOR,
    predicationMode: s = St.DISABLED
  } = {}) {
    super("SMAAEffect", bt, {
      vertexShader: Ht,
      blendFunction: e,
      attributes: S.CONVOLUTION | S.DEPTH,
      uniforms: /* @__PURE__ */ new Map([
        ["weightMap", new l(null)]
      ])
    });
    let r, n;
    arguments.length > 1 && (r = arguments[0], n = arguments[1], arguments.length > 2 && (t = arguments[2]), arguments.length > 3 && (i = arguments[3])), this.renderTargetEdges = new x(1, 1, { depthBuffer: !1 }), this.renderTargetEdges.texture.name = "SMAA.Edges", this.renderTargetWeights = this.renderTargetEdges.clone(), this.renderTargetWeights.texture.name = "SMAA.Weights", this.uniforms.get("weightMap").value = this.renderTargetWeights.texture, this.clearPass = new J(!0, !1, !1), this.clearPass.overrideClearColor = new ae(0), this.clearPass.overrideClearAlpha = 1, this.edgeDetectionPass = new ie(new yt()), this.edgeDetectionMaterial.edgeDetectionMode = i, this.edgeDetectionMaterial.predicationMode = s, this.weightsPass = new ie(new Lt());
    const a = new me();
    a.onLoad = () => {
      const o = new z(r);
      o.name = "SMAA.Search", o.magFilter = Q, o.minFilter = Q, o.generateMipmaps = !1, o.needsUpdate = !0, o.flipY = !0, this.weightsMaterial.searchTexture = o;
      const c = new z(n);
      c.name = "SMAA.Area", c.magFilter = O, c.minFilter = O, c.generateMipmaps = !1, c.needsUpdate = !0, c.flipY = !1, this.weightsMaterial.areaTexture = c, this.dispatchEvent({ type: "load" });
    }, a.itemStart("search"), a.itemStart("area"), r !== void 0 && n !== void 0 ? (a.itemEnd("search"), a.itemEnd("area")) : typeof Image < "u" && (r = new Image(), n = new Image(), r.addEventListener("load", () => a.itemEnd("search")), n.addEventListener("load", () => a.itemEnd("area")), r.src = se, n.src = re), this.applyPreset(t);
  }
  /**
   * The edges texture.
   *
...
#endif
l0=max(minLuminance,l0);l1=max(minLuminance,l1);float adaptedLum=l0+(l1-l0)*(1.0-exp(-deltaTime*tau));gl_FragColor=(adaptedLum==1.0)?vec4(1.0):packFloatToRGBA(adaptedLum);}`, Ut = class extends M {
  /**
  ...
  constructor() {
    super({
      ...
      uniforms: {
        luminanceBuffer0: new l(null),
        luminanceBuffer1: new l(null),
        minLuminance: new l(0.01),
        deltaTime: new l(0),
        tau: new l(1)
      },
      extensions: {
  ...
  constructor(e, { minLuminance: t = 0.01, adaptationRate: i = 1 } = {}) {
    super("AdaptiveLuminancePass"), this.fullscreenMaterial = new Ut(), this.needsSwap = !1, this.renderTargetPrevious = new x(1, 1, {
      minFilter: Q,
      magFilter: Q,
      depthBuffer: !1
    }), this.renderTargetPrevious.texture.name = "Luminance.Previous";
    const s = this.fullscreenMaterial;
    s.luminanceBuffer0 = this.renderTargetPrevious.texture, s.luminanceBuffer1 = e, s.minLuminance = t, s.adaptationRate = i, this.renderTargetAdapted = this.renderTargetPrevious.clone(), this.renderTargetAdapted.texture.name = "Luminance.Adapted", this.copyPass = new Ae(this.renderTargetPrevious, !1);
  }
  /**
   ...
   */
  render(e, t, i, s, r) {
    this.fullscreenMaterial.deltaTime = s, e.setRenderTarget(this.renderToScreen ? null : this.renderTargetAdapted), e.render(this.scene, this.camera), this.copyPass.render(e, this.renderTargetAdapted);
  }
}, zt = `#include <tonemapping_pars_fragment>
...
outputColor=vec4(toneMapping(inputColor.rgb),inputColor.a);
  ...
  constructor({
    blendFunction: e = u.SRC,
    adaptive: t = !1,
    mode: i = t ? E.REINHARD2_ADAPTIVE : E.AGX,
    resolution: s = 256,
    maxLuminance: r = 4,
    whitePoint: n = r,
    middleGrey: a = 0.6,
    ...
    super("ToneMappingEffect", zt, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["luminanceBuffer", new l(null)],
        ["maxLuminance", new l(r)],
        // Unused
        ["whitePoint", new l(n)],
        ["middleGrey", new l(a)],
        ["averageLuminance", new l(c)]
      ])
    }), this.renderTargetLuminance = new x(1, 1, {
      minFilter: Be,
      depthBuffer: !1
    }), this.renderTargetLuminance.texture.generateMipmaps = !0, this.renderTargetLuminance.texture.name = "Luminance", this.luminancePass = new fe({
      renderTarget: this.renderTargetLuminance
    }), this.adaptiveLuminancePass = new Ft(this.luminancePass.texture, {
      minLuminance: o,
      adaptationRate: A
    }), this.uniforms.get("luminanceBuffer").value = this.adaptiveLuminancePass.texture, this.resolution = s, this.mode = i;
  }
  /**
  ...
  set mode(e) {
    if (this.mode === e)
      return;
    const i = H.replace(/\D+/g, "") >= 168 ? "CineonToneMapping(texel)" : "OptimizedCineonToneMapping(texel)";
    ...
    this.adaptiveLuminancePass.enabled = e === E.REINHARD2_ADAPTIVE, this.setChanged();
  }
  /**
   ...
   */
  get adaptive() {
    return this.mode === E.REINHARD2_ADAPTIVE;
  }
  set adaptive(e) {
    this.mode = e ? E.REINHARD2_ADAPTIVE : E.REINHARD2;
  }
  /**
   * The luminance adaptation rate.
   *
...
#endif
#include <dithering_fragment>
}`, Nt = "uniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;VERTEX_HEAD void main(){vUv=position.xy*0.5+0.5;VERTEX_MAIN_SUPPORT gl_Position=vec4(position.xy,1.0,1.0);}", kt = class extends M {
  /**
   ...
   */
  setShaderParts(e) {
    return this.fragmentShader = Qt.replace(f.FRAGMENT_HEAD, e.get(f.FRAGMENT_HEAD) || "").replace(f.FRAGMENT_MAIN_UV, e.get(f.FRAGMENT_MAIN_UV) || "").replace(f.FRAGMENT_MAIN_IMAGE, e.get(f.FRAGMENT_MAIN_IMAGE) || ""), this.vertexShader = Nt.replace(f.VERTEX_HEAD, e.get(f.VERTEX_HEAD) || "").replace(f.VERTEX_MAIN_SUPPORT, e.get(f.VERTEX_MAIN_SUPPORT) || ""), this.needsUpdate = !0, this;
  }
  /**
  ...
  copyCameraSettings(e) {
    e && (this.uniforms.cameraNear.value = e.near, this.uniforms.cameraFar.value = e.far, e instanceof we ? this.defines.PERSPECTIVE_CAMERA = "1" : delete this.defines.PERSPECTIVE_CAMERA, this.needsUpdate = !0);
  }
  /**
   * Sets the resolution.
   *
...
function Yt(e, t, i) {
  ...
  if (a && i.attributes & S.CONVOLUTION)
  ...
  {
    const o = /\w+\s+(\w+)\([\w\s,]*\)\s*{/g, c = i.shaderParts;
    let A = c.get(f.FRAGMENT_HEAD) || "", p = c.get(f.FRAGMENT_MAIN_UV) || "", d = c.get(f.FRAGMENT_MAIN_IMAGE) || "", g = c.get(f.VERTEX_HEAD) || "", B = c.get(f.VERTEX_MAIN_SUPPORT) || "";
    const R = /* @__PURE__ */ new Set(), w = /* @__PURE__ */ new Set();
    if (a && (p += `	${e}MainUv(UV);
`, i.uvTransformation = !0), r !== null && /mainSupport/.test(r)) {
      const m = /mainSupport *\([\w\s]*?uv\s*?\)/.test(r);
      B += `	${e}MainSupport(`, B += m ? `vUv);
` : `);
`;
      for (const D of r.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))
        for (const k of D[1].split(/\s*,\s*/))
          i.varyings.add(k), R.add(k), w.add(k);
      for (const D of r.matchAll(o))
        w.add(D[1]);
    }
    for (const m of s.matchAll(o))
      w.add(m[1]);
    for (const m of t.defines.keys())
      w.add(m.replace(/\([\w\s,]*\)/g, ""));
    for (const m of t.uniforms.keys())
      w.add(m);
    w.delete("while"), w.delete("for"), w.delete("if"), t.uniforms.forEach((m, D) => i.uniforms.set(e + D.charAt(0).toUpperCase() + D.slice(1), m)), t.defines.forEach((m, D) => i.defines.set(e + D.charAt(0).toUpperCase() + D.slice(1), m));
    const N = /* @__PURE__ */ new Map([["fragment", s], ["vertex", r]]);
    ne(e, w, i.defines), ne(e, w, N), s = N.get("fragment"), r = N.get("vertex");
    const G = t.blendMode;
    if (i.blendModes.set(G.blendFunction, G), n) {
      t.inputColorSpace !== null && t.inputColorSpace !== i.colorSpace && (d += t.inputColorSpace === v ? `color0 = sRGBTransferOETF(color0);
	` : `color0 = sRGBToLinear(color0);
	`), t.outputColorSpace !== ce ? i.colorSpace = t.outputColorSpace : t.inputColorSpace !== null && (i.colorSpace = t.inputColorSpace);
      const m = /MainImage *\([\w\s,]*?depth[\w\s,]*?\)/;
      d += `${e}MainImage(color0, UV, `, i.attributes & S.DEPTH && m.test(s) && (d += "depth, ", i.readDepth = !0), d += `color1);
	`;
      const D = e + "BlendOpacity";
      i.uniforms.set(D, G.opacity), d += `color0 = blend${G.blendFunction}(color0, color1, ${D});
...
`;
    ...
    if (A += s + `
`, r !== null && (g += r + `
`), c.set(f.FRAGMENT_HEAD, A), c.set(f.FRAGMENT_MAIN_UV, p), c.set(f.FRAGMENT_MAIN_IMAGE, d), c.set(f.VERTEX_HEAD, g), c.set(f.VERTEX_MAIN_SUPPORT, B), t.extensions !== null)
      for (const m of t.extensions)
        i.extensions.add(m);
  }
}
var Zt = class extends C {
   ...
   */
  constructor(e, ...t) {
    super("EffectPass"), this.fullscreenMaterial = new kt(null, null, null, e), this.listener = (i) => this.handleEvent(i), this.effects = [], this.setEffects(t), this.skipRendering = !1, this.minTime = 1, this.maxTime = Number.POSITIVE_INFINITY, this.timeScale = 1;
  }
  set mainScene(e) {
  ...
  updateMaterial() {
    ...
    for (const a of this.effects)
      if (a.blendMode.blendFunction === u.DST)
        e.attributes |= a.getAttributes() & S.DEPTH;
      else {
        if (e.attributes & a.getAttributes() & S.CONVOLUTION)
          throw new Error(`Convolution effects cannot be merged (${a.name})`);
        Yt("e" + t++, a, e);
      }
    let i = e.shaderParts.get(f.FRAGMENT_HEAD), s = e.shaderParts.get(f.FRAGMENT_MAIN_IMAGE), r = e.shaderParts.get(f.FRAGMENT_MAIN_UV);
    const n = /\bblend\b/g;
    for (const a of e.blendModes.values())
      i += a.getShaderCode().replace(n, `blend${a.blendFunction}`) + `
`;
    e.attributes & S.DEPTH ? (e.readDepth && (s = `float depth = readDepth(UV);

	` + s), this.needsDepthTexture = this.getDepthTexture() === null) : this.needsDepthTexture = !1, e.colorSpace === v && (s += `color0 = sRGBToLinear(color0);
	`), e.uvTransformation ? (r = `vec2 transformedUv = vUv;
` + r, e.defines.set("UV", "transformedUv")) : e.defines.set("UV", "vUv"), e.shaderParts.set(f.FRAGMENT_HEAD, i), e.shaderParts.set(f.FRAGMENT_MAIN_IMAGE, s), e.shaderParts.set(f.FRAGMENT_MAIN_UV, r);
...
export {
  Ut as AdaptiveLuminanceMaterial,
  Ft as AdaptiveLuminancePass,
  u as BlendFunction,
  At as BlendMode,
  Wt as BloomEffect,
  vt as BlurPass,
  Ie as ClearMaskPass,
  J as ClearPass,
  yt as ColorEdgesMaterial,
  ht as ConvolutionMaterial,
  ue as CopyMaterial,
  Ae as CopyPass,
  Et as DownsamplingMaterial,
  yt as EdgeDetectionMaterial,
  de as EdgeDetectionMode,
  j as Effect,
  S as EffectAttribute,
  Xt as EffectComposer,
  kt as EffectMaterial,
  Zt as EffectPass,
  Pe as EffectShaderData,
  f as EffectShaderSection,
  ht as KawaseBlurMaterial,
  vt as KawaseBlurPass,
  Z as KernelSize,
  mt as LuminanceMaterial,
  fe as LuminancePass,
  ye as MaskPass,
  Tt as MipmapBlurPass,
  te as OverrideMaterialManager,
  C as Pass,
  St as PredicationMode,
  Kt as RenderPass,
  T as Resizer,
  T as Resolution,
  Jt as SMAAEffect,
  b as SMAAPreset,
  Lt as SMAAWeightsMaterial,
  Ae as SavePass,
  f as Section,
  ie as ShaderPass,
  Me as Timer,
  jt as ToneMappingEffect,
  E as ToneMappingMode,
  wt as UpsamplingMaterial
};
